    ...
    <div className="px-2 lg:px-7 pt-5">
      <div className="flex lg:hidden justify-between items-center mb-5 p-4 bg-[#6a5fdf] rounded-md">
        ...
        <button
          ...
          className="text-[#d0d2d6] bg-red-500 shadow-lg hover:shadow-red-500/50 px-4 py-2 cursor-pointer text-white rounded-sm text-sm"
        >
          Add
        </button>
      </div>
          ...
          <div className="w-full p-4 bg-[#6a5fdf] rounded-md">
            ...
            <div className="relative overflow-x-auto">
              <table className="w-full text-sm text-left text-[#d0d2d6]">
                <thead className="uppercase border-b border-slate-700 text-sm text-[#d0d2d6] border-b border-slate-700">
                  <tr>
              ...
              <form>
                <div className="flex flex-col w-full gap-1 mb-3">
                  ...
                  <input
                    ...
                    className="px-4 py-2 focus:border-indigo-500 outline-none bg-[#fff] border border-slate-700 rounded-md text-[#d0d2d6]"
                  />
                </div>
                <div>
                  <label
                ...
                <button className="bg-red-500 w-full hover:shadow-red-500/40 hover:shadow-lg text-white rounded-md px-7 py-2 my-2">
                  Add Category
                </button>
              </form>
            </div>
